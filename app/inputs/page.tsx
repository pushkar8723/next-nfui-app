...
export default function Inputs() {
    ...
    const schema = yup.object({
        ...
        workType: yup
            .string()
            .required("Please select your preferred work type"),
    ...
    const handleSubmit = (values: typeof initialValues) => {
        setMessage(`
            ...
            values.workType
        }</strong>, and OS of choice is <strong>${values.os}</strong>.<br/>
            Currenlty residing at <strong>${values.line1}, ${values.line2}, ${
            values.city
        }, ${values.state}, ${values.zip}</strong>.<br/>
            ${
                values.newsletter
    ...
    return (
        <>
            <Header
                title="Inputs Demo"
                docLink="https://nfui.js.org/?path=/docs/declarative-components-input--docs"
            />
